...
import PrintLib from "./02PrintLib.js";
    ...
    var  BasePrintElement = function () {
        function BasePrintElement(v10205) {
          this.printElementType = v10205, this.id = PrintLib.instance.guid();
        }
  
        return BasePrintElement.prototype.getConfigOptionsByName = function (v10207) {
          return PrintConfig.instance[v10207];
          ...
          this.designTarget.hidraggable({
            ...
            onBeforeDrag: function onBeforeDrag(v10246) {
              PrintLib.instance.draging = !0, v10238.designTarget.focus(), v10238.createLineOfPosition(v10237);
            },
            onBeforeSelectAllDrag: function onBeforeSelectAllDrag() {
              PrintLib.instance.draging = !0, v10238.designTarget.focus();
            },
            ...
            onStopDrag: function onStopDrag(v10249) {
              // 普通元素拖动结束事件history
              if (PrintLib.instance.changed) hinnn.event.trigger("hiprintTemplateDataChanged_" + v10238.templateId, "移动");
          ...
          return v10255 ? new PrintElementEntity(void 0, this.options.getPrintElementOptionEntity(), this.printElementType.getPrintElementTypeEntity()) : new PrintElementEntity(this.printElementType.tid, this.options.getPrintElementOptionEntity());
          ...
          this.designTarget.hireizeable({
            ...
            onStopResize: function onStopResize(v10293) {
              ...
              PrintLib.instance.draging = !1, v10284.removeLineOfPosition();
            }
          });
          ...
          this.isHeaderOrFooter() || this.isFixed() || v10307 > v10308 && "none" != v10302.panelPageRule && (v10306.push(new PaperHtmlResult({
            target: void 0,
            printLine: void 0
          ...
          this.updateTargetSize(v10311), this.css(v10311, v10310), v10311.css("position", "absolute"), v10311.css("left", this.options.displayLeft()), v10311.css("top", v10307 + "pt"), v10306.push(new PaperHtmlResult({
            target: v10311,
          ...
          if (v10303 && this.options.pageBreak) {
            ...
            v10306.unshift(new PaperHtmlResult({
              target: v10311,
          ...
          this.isHeaderOrFooter() || this.isFixed() || ("none" != v10316.panelPageRule && v10321 > v10322 && (v10320.push(new PaperHtmlResult({
            target: void 0,
            printLine: void 0
            // (e && r + this.options.getHeight() > a) --> 设计时拖拽元素高度超过页脚线时,导致报错问题
          })), v10321 = v10321 - v10322 + v10316.paperHeader, v10319++, v10322 = v10316.getPaperFooter(v10319)), v10321 <= v10322 && v10317 && v10321 + this.options.getHeight() > v10322 && "none" != v10316.panelPageRule && (v10320.push(new PaperHtmlResult({
            target: void 0,
            printLine: void 0
          ...
          this.updateTargetSize(v10326), this.css(v10326, v10325), v10326.css("position", "absolute"), v10326.css("left", this.options.displayLeft()), v10326.css("top", v10321 + "pt"), v10320.push(new PaperHtmlResult({
            target: v10326,
          ...
          if (v10317 && this.options.pageBreak) {
            ...
            v10320.unshift(new PaperHtmlResult({
              target: v10326,
          ...
          if (v10339) {
            ...
            v10340 && v10340.forEach(function (v10342) {
              var v10343 = PrintElementOptionItemManager.getItem(v10342.name);
          ...
          if (v10360) {
            ...
            v10361 && v10361.forEach(function (v10362, v10363) {
              ...
              v10362.options.filter(function (v10364) {
                ...
                var v10366 = PrintElementOptionItemManager.getItem(v10365.name);
          ...
          if (v10369) {
            ...
            v10370 && v10370.filter(function (v10372) {
              ...
              var v10374 = PrintElementOptionItemManager.getItem(v10373.name);
          ...
          if (v10378) {
            ...
            v10379 && v10379.filter(function (v10381) {
              ...
              var v10383 = PrintElementOptionItemManager.getItem(v10382.name);
          ...
          var config = PrintConfig.instance;
          ...
          return v10398 || (v10398 = PrintLib.instance.getPrintTemplateById(this.templateId).getFontList());
          ...
          return v10400 || (v10400 = PrintLib.instance.getPrintTemplateById(this.templateId).getFields());
        }, BasePrintElement.prototype.getOnImageChooseClick = function () {
          var v10402 = this.options.onImageChooseClick;
          return v10402 || (v10402 = PrintLib.instance.getPrintTemplateById(this.templateId).getOnImageChooseClick());
          ...
          v10415.attr("tabindex", "1"), v10415.keydown(function (v10420) {
            ...
            var isMultiple = els.length > 1;
            var movingDistance = PrintConfig.instance.movingDistance;
            switch (v10420.keyCode) {
              // BackSpace/Delete 删除元素
              case 8:
              case 46:
                var templete = PrintLib.instance.getPrintTemplateById(v10417.templateId);
