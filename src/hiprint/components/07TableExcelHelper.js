...
class TableExcelHelper {
  static createTableHead(v10548, v10549) {
    for (
      var v10550 = TableExcelHelper.reconsitutionTableColumnTree(v10548),
        v10551 = $("<thead></thead>"),
        colgroup = $("<colgroup></colgroup>"),
        v10552 = TableExcelHelper.getColumnsWidth(v10550, v10549),
        v10553 = function v10554(v10555) {
          var v10556 = $("<tr></tr>");
          // 重置 colgroup，解决多行表头 col 添加错误问题，仅以最后一行添加
          colgroup = $("<colgroup></colgroup>");
          v10550[v10555]
            .filter(function (v10557) {
              return v10557.checked;
            })
            .forEach(function (v10558) {
              var v10559 = $("<td></td>");
              v10558.id && v10559.attr("id", v10558.id),
                v10558.columnId && v10559.attr("column-id", v10558.columnId),
                (v10558.align || v10558.halign) &&
                  v10559.css("text-align", v10558.halign || v10558.align),
                v10558.vAlign && v10559.css("vertical-align", v10558.vAlign),
                v10558.colspan > 1 && v10559.attr("colspan", v10558.colspan),
                v10558.rowspan > 1 && v10559.attr("rowspan", v10558.rowspan),
                v10559.html(v10558.title),
                v10552[v10558.id]
                  ? ((v10558.hasWidth = !0),
                    (v10558.targetWidth = v10552[v10558.id]),
                    v10559.attr("haswidth", "haswidth"),
                    v10559.css("width", v10552[v10558.id] + "pt"))
                  : (v10558.hasWidth = !1);
              var v10560 = TableExcelHelper.getHeaderStyler(v10558);
              if (v10560) {
                var v10561 = v10560(v10558);
                if (v10561)
                  Object.keys(v10561).forEach(function (v10562) {
                    v10559.css(v10562, v10561[v10562]);
                  });
              }
              v10556.append(v10559);
              colgroup.append(
                `<col column-id="${v10558.columnId}" width="${v10558.width}pt"></col>`
              );
            }),
            v10551.append(v10556);
        },
        v10563 = 0;
      v10563 < v10550.totalLayer;
      v10563++
    ) {
      v10553(v10563);
    }
  ...
  static createTableFooter(v10564, v10565, v10566, v10567, v10568, v10569) {
    // n=>options e=>表格所有数据 o=>所有打印数据 r=>表格每页数据
    var v10570 = $("<tfoot></tfoot>"),
      v10571 = this.getFooterFormatter(v10566, v10567);
          ...
          switch (column.tableSummary) {
            case "count":
              ...
              var count = toUpperCase(
                upperCaseType,
                tSumData.filter((v10574) => v10574).length || 0
              );
              tableFooter.append(
  ...
  static tableSummaryTitle(column, title, data) {
    var v10575 =
      column.tableSummaryTitle == undefined || column.tableSummaryTitle == true;
    return v10575
      ? `${title}`
      : data
      ? ``
  ...
  static createTableRow(v10576, v10577, printData, v10578, v10579) {
    var v10580 = this;
    var v10581 = TableExcelHelper.reconsitutionTableColumnTree(v10576),
      v10582 = $("<tbody></tbody>");
    var gff = v10580.getGroupFieldsFormatter(v10578, v10579);
    var groupFields = gff
      ? (v10578.groupFields = gff(v10579, v10578, v10577))
      : v10579.groupFields
      ? v10579.groupFields
      : [];
    (v10577 || (v10577 = []), groupFields.length)
      ? hinnn
          .groupBy(v10577, groupFields, function (v10584) {
            var v10585 = {};
            return (
              groupFields.forEach(function (v10586) {
          ...
          .forEach(function (v10587) {
            ...
            var groupFooterFormatter = v10580.getGroupFooterFormatter(
              v10578,
              v10579
            );
            var groupData = v10587;
            if (
              (groupData.rows.forEach(function (v10588, rowIndex) {
                var v10589 = TableExcelHelper.createRowTarget(
                  v10581,
                  v10588,
                  v10578,
                  v10579,
  ...
  static createRowTarget(
    ...
    v10595.data("rowData", v10592),
      v10591.rowColumns
        .filter(function (v10597) {
        ...
        .forEach(function (v10598, v10599) {
          ...
          if (
            v10592 &&
            Object.keys(v10592).length > 0 &&
            ("first" == v10593.tableHeaderRepeat ||
              "none" == v10593.tableHeaderRepeat)
          ) {
            v10598.field && v10600.attr("field", v10598.field),
              v10598.align && v10600.css("text-align", v10598.align),
              v10598.vAlign && v10600.css("vertical-align", v10598.vAlign);
          ...
          var v10601 = TableExcelHelper.getColumnFormatter(v10598),
            v10602 = v10601
              ? v10601(v10592[v10598.field], v10592, v10599, v10593)
              : v10592[v10598.field];
          var rf = TableExcelHelper.getColumnRenderFormatter(v10598);
          if (rf) {
            v10600.html(
              rf(v10592[v10598.field], v10592, v10599, v10593, rowIndex)
            );
            //表格内容插入二维码等
          } else if (
            "text" == v10598.tableTextType ||
            v10598.tableTextType == void 0
          )
            v10600.html(v10602);
          else {
            if ("barcode" == v10598.tableTextType) {
              ...
              try {
                v10602
                  ? (JsBarcode(v10600.find(".hibarcode_imgcode")[0], v10602, {
                    ...
                    v10600
                      ...
                      .attr("height", v10598.tableColumnHeight || 30 + "pt"),
                    v10600.find(".hibarcode_imgcode").css("margin", "5pt 10pt"),
                    v10600
                      .find(".hibarcode_imgcode")
            ...
            if ("qrcode" == v10598.tableTextType) {
              ...
              try {
                ...
                if (v10602) {
                  var v10604 = parseInt(
                      v10598.width || v10598.targetWidth || 20
                    ),
                    v10605 = parseInt(v10598.tableColumnHeight || 20);
                  qrcodebox.css(
                    "height",
                    (v10604 > v10605 ? v10605 : v10604) + "pt"
                  );
                  ...
                  if (v10598.showCodeTitle) {
                    v10600.append('<div class="hiqrcode_displayValue"></div>');
                    v10600.find(".hiqrcode_displayValue").html(v10602);
                  }
                }
              } catch (v10606) {
                console.log(v10606),
                  v10600.html(`${i18n.__("二维码生成失败")}`);
              }
            }
          ...
          if (v10607) {
            ...
            if (v10604)
              Object.keys(v10604).forEach(function (v10608) {
    ...
    if (v10609) {
      ...
      if (v10610)
        Object.keys(v10610).forEach(function (v10611) {
  ...
  static createEmptyRowTarget(v10612, tableElement) {
    var v10613 = TableExcelHelper.reconsitutionTableColumnTree(v10612),
      v10614 = $("<tr></tr>");
    v10613.rowColumns
      .filter(function (v10615) {
        return v10615.checked;
      })
      .forEach(function (v10616, v10617) {
        var v10618 = $("<td></td>");
        v10616.field && v10618.attr("field", v10616.field),
          v10616.align && v10618.css("text-align", v10616.align),
          v10616.vAlign && v10618.css("vertical-align", v10616.vAlign),
          v10614.append(v10618);
      });
  ...
  static resizeTableCellWidth(v10628, v10629, v10630) {
  ...
  static allAutoWidth(v10637) {
    var v10638 = 0,
      v10639 = {};
    return (
      v10637.rowColumns
        .filter(function (v10640) {
          return v10640.checked;
        })
        .forEach(function (v10641) {
          v10639[v10641.id]
            ? (v10639[v10641.id] = 0)
            : (v10639[v10641.id] = v10641.width);
          v10638 += v10641.fixed ? 0 : v10639[v10641.id];
        }),
      v10638
    );
  }
  static allFixedWidth(v10642) {
    var v10643 = 0,
      v10644 = {};
    return (
      v10642.rowColumns
        .filter(function (v10645) {
          return v10645.checked;
        })
        .forEach(function (v10646) {
          v10644[v10646.id]
            ? (v10644[v10646.id] = 0)
            : (v10644[v10646.id] = v10646.width);
          v10643 += v10646.fixed ? v10644[v10646.id] : 0;
        }),
      v10643
    );
  }
  static reconsitutionTableColumnTree(v10647, v10648, v10649) {
    var v10650 = v10648 || new ReconsitutionTableColumns();
    v10650.colspan = 0;

    for (
      var v10652 = function v10653(v10654) {
          (v10650.totalLayer = v10654 + 1),
            (v10650[v10654] = v10647[v10654].columns),
            0 == v10654 &&
              v10647[v10654].columns.forEach(function (v10655) {
                0 == v10654 && (v10650.colspan += v10655.colspan);
              });
        },
        v10656 = 0;
      v10656 < v10647.length;
      v10656++
    ) {
      v10652(v10656);
    }
    ...
    return (
      (v10650.rowColumns = TableExcelHelper.getOrderdColumns(v10650)), v10650
    );
  }
  static syncTargetWidthToOption(v10657) {
  ...
  static getColumnRenderFormatter(column) {
    ...
    if (
      (column.renderFormatter && (renderFormatter = column.renderFormatter),
  ...
  static getOrderdColumns(v10680) {
    // 新数据
    let newColumns = {};
    ...
    for (let v10682 = 0; v10682 < v10680.totalLayer; v10682++) {
      newColumns[v10682].forEach((column, columnIdx) => {
        for (let v10683 = 1; v10683 < column.rowspan; v10683++) {
          newColumns[v10682 + v10683].splice(columnIdx, 0, {
            ...column,
            rowspan: 1,
          });
        }
