...
export default function (webpack_module, webpack_exports, webpack_require) {
    ...
    webpack_require.d(webpack_exports, "init", function () {
      return mt;
    }), webpack_require.d(webpack_exports, "setConfig", function () {
      return cig;
    }), webpack_require.d(webpack_exports, "updateElementType", function () {
      return uep;
    }), webpack_require.d(webpack_exports, "hiwebSocket", function () {
      return hiwebSocket;
    }), webpack_require.d(webpack_exports, "refreshPrinterList", function () {
      return rpl;
    }), webpack_require.d(webpack_exports, "getClients", function () {
      return getClients;
    }), webpack_require.d(webpack_exports, "getClientInfo", function () {
      return getClientInfo;
    }), webpack_require.d(webpack_exports, "getAddress", function () {
      return getAddr;
    }), webpack_require.d(webpack_exports, "ippPrint", function () {
      return ippPrint;
    }), webpack_require.d(webpack_exports, "ippRequest", function () {
      return ippRequest;
    }), webpack_require.d(webpack_exports, "PrintElementTypeManager", function () {
      return it;
    }), webpack_require.d(webpack_exports, "PrintElementTypeGroup", function () {
      return ot;
    }), webpack_require.d(webpack_exports, "PrintTemplate", function () {
      return ct;
    }), webpack_require.d(webpack_exports, "print", function () {
      return ht;
    }), webpack_require.d(webpack_exports, "print2", function () {
      return ft;
    }), webpack_require.d(webpack_exports, "getHtml", function () {
      return gt;
